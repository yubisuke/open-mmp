...
Validation is read-only. It checks 28 schemas, 8 registries, 53 reviewed synthetic fixtures, 689 golden output artifacts, 53 scenario assertions, 26 acceptance criteria, semantic and metamorphic mutations, deterministic TypeScript output, independent Python output, and RFC 8785 conformance. See the [fixture provenance note](fixtures/v0.4/README.md).
