...
const appEntries: Record<string, string> = {
  ...
  OPENMASU_WELLKNOWN_RATE_RPS: "20",
  OPENMASU_WELLKNOWN_RATE_BURST: "50",
  OPENMASU_WELLKNOWN_MAX_BYTES: "131072",
  ...
  OPENMASU_FRAUD_BUNDLE_PATH: "config/fraud-bundles/conservative-v1.json",
  OPENMASU_FRAUD_CTIT_LOWER_BOUND_SECONDS: "10",
  OPENMASU_FRAUD_AGGREGATE_HOUR_UTC: "2",
  OPENMASU_FRAUD_QUARANTINE_HOURS: "72",
